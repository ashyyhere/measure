...
private const val REACT_NATIVE_BUNDLE_ARCHIVE_NAME = "mapping-android.tgz"
...
class MeasurePlugin : Plugin<Project> {
    ...
    private fun registerBuildTasks(
        ...
        val rnBundleArchiveProperty = project.objects.fileProperty()
        ...
        val uploadBuildProvider =
            project.tasks
                .register(
                    ...
                    it.reactNativeBundleArchiveProperty.set(rnBundleArchiveProperty)
        ...
        wireReactNativeBundle(project, variant, rnBundleArchiveProperty)
    }
    ...
    private fun wireReactNativeBundle(
        project: Project,
        variant: Variant,
        rnBundleArchiveProperty: RegularFileProperty,
    ) {
        ...
        project.tasks.matching { it.name in candidateNames }.configureEach { bundleTask ->
            ...
            rnBundleArchiveProperty.set(packageTask.flatMap { it.archiveFile })
        }
    }
